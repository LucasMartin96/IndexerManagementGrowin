"""
CRUD operations for params (key-value storage)
"""
...
def get_param_value(key: str, default: Optional[str] = None) -> Optional[str]:
    """
    Get parameter value by key (convenience method)
