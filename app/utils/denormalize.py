...
# Note: mysql_query is now in app.db.mysql, but keeping here for backward compatibility
from app.db.mysql import mysql_query as _mysql_query
...
def mysql_query(query, params=None, conn=None):
    ...
    """
    return _mysql_query(query, params, conn)
